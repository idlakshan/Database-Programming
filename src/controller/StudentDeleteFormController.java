...
public class StudentDeleteFormController {
    ...
    public void txtStudentIdOnAction(ActionEvent event) throws SQLException {
    ...
    public void btnDeleteOnAction(ActionEvent event) throws SQLException {
        PreparedStatement statement = DBConnection.getInstance().getConnection().prepareStatement("delete from Student where student_id=?");
        statement.setObject(1, txtId.getText());
